...
/* Несколько параметров в маршрутах */
...
/* whereAlpha - делает ограничение только на буквы
   whereNumber - делает ограничение только на числа
   whereAlphaNumeric - делает ограничение на буквы и цифры
...
Route::get('/hello5/{name}', [PostController::class, 'hello5'])->where('id', '[1-5]');
